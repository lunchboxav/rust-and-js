...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'stdweb_demo.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'stdweb_demo.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'stdweb_demo.temp.asm.js';
...
var ASM_CONSTS = [function($0) { Module.STDWEB.increment_refcount( $0 ); },
 ...
 function($0, $1) { Module.STDWEB.from_js($0, (function(){alert (Module.STDWEB.to_js($1));})()); },
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "stdweb_demo.js.mem" : null;
...
Module['wasmTableSize'] = 2368;

Module['wasmMaxTableSize'] = 2368;
